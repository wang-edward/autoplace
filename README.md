...
This isn't meant to one-shot a component layout, but as a helpful first step to group related components. **It works best when Edge.Cuts is well defined, and static components (like ports) are locked.**
